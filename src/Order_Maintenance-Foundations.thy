...
where
  "h\<^sub>1 < h\<^sub>2 \<Longrightarrow> (h\<^sub>1, i\<^sub>1) \<squnion> (h\<^sub>2, i\<^sub>2) = (h\<^sub>2, i\<^sub>1 div 2 ^ (h\<^sub>2 - h\<^sub>1)) \<squnion> (h\<^sub>2, i\<^sub>2)" |
  "h\<^sub>1 > h\<^sub>2 \<Longrightarrow> (h\<^sub>1, i\<^sub>1) \<squnion> (h\<^sub>2, i\<^sub>2) = (h\<^sub>1, i\<^sub>1) \<squnion> (h\<^sub>1, i\<^sub>2 div 2 ^ (h\<^sub>1 - h\<^sub>2))" |
